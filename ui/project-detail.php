<?php
	...
	if (!isset($project_details)) {
    	error_log("The detailed data for this client is not available. Please investigate why this happened, project_details.php, line 23");
		exit;
	}
?>
<!DOCTYPE html>
