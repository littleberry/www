	...
	<nav id="site-nav" class="site-nav">
		<ul id="site-menu" class="site-menu">
			...
			<?php //if ($header_controller_vars->getValueEncoded("person_perm_id") != "Regular User") {
				?>			<li class="site-menu-item"><a class="site-menu-link" href="http://localhost:8888/time_tracker/ci/index.php/report?fromdate=<?php echo date("Y-m-d", strtotime("last sunday", strtotime(date("Y-m-d"))));?>&todate=<?php echo date("Y-m-d", strtotime("this saturday", strtotime(date("Y-m-d"))));?>&page=clients">Reports</a></li>
